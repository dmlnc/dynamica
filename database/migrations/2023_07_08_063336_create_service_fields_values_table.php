...
class CreateServiceFieldsValuesTable extends Migration
{
    public function up()
    {
        Schema::create('service_fields_values', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('service_fields_values');
    }
}
